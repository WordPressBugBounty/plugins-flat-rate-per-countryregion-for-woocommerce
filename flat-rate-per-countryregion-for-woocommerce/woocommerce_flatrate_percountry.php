			...
			function admin_options() {
				...
				<div id="wc_flatrate_wd">
					<div id="wc_flatrate_wd_rightbar">
						...
						<p><a href="https://translate.wordpress.org/projects/wp-plugins/flat-rate-per-countryregion-for-woocommerce/" target="_blank">WordPress.org</a></p>
						<hr/>
					...
					<div id="wc_flatrate_wd_settings">
						<h2><?php echo $this->method_title; ?> <?php echo $this->version; ?></h2>
						<h3 style="font-weight: normal;"><?php _e( 'This is a legacy shipping method and you should be using Shipping zones by now.', 'flat-rate-per-countryregion-for-woocommerce' ); ?></h3>
